                ...
                Align(
                  ...
                  child: Obx(() {
                    ...
                    return IconButton(
                      ...
                      onPressed: () {
                        mycontroller.toggle();
                        course1Controller.toggleFavorite(
                            course1Controller.courses.indexOf(course));
                      },
                    );
                  }),
                ),
...
class CourseController1 extends GetxController {
  RxList<CourseI> courses = [
    CourseI(title: 'Fields', art: '10 articles', next: '/numb'),
    CourseI(title: 'Groups', art: '15 articles', next: '/add'),
    CourseI(title: 'Rings', art: '12 articles', next: '/mul'),
...
class Algebraiii extends StatelessWidget {
