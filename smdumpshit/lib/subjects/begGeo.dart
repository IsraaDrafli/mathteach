...
class Course extends StatelessWidget {
  ...
  final CourseController2 course2Controller = Get.put(CourseController2());
                ...
                Align(
                  ...
                  child: Obx(() {
                    ...
                    return IconButton(
                      ...
                      onPressed: () {
                        mycontroller.toggle();
                         course2Controller.toggleFavorite(course);
                      },
                    );
                  }),
                ),
...
class CourseController2 extends GetxController {
  ...
  RxList<CourseI> courses = [
    CourseI(title: 'Shapes', art: '10 articles', next: '/shapes'),
    CourseI(title: 'Angles', art: '15 articles', next: '/ang'),
    CourseI(title: 'Perimeter', art: '12 articles', next: '/per'),
    CourseI(title: 'Areas', art: '6 articles', next: '/areas'),
...
List<String> images = [
  'images/rr.png',
  'images/crs/angl.jpg',
  'images/crs/perimeter.jpg',
  'images/crs/area.jpg'
];

class begGeo extends StatelessWidget {
  final CourseController2 courseController = Get.put(CourseController2());
  @override
  Widget build(BuildContext context) {
